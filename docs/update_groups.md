...
> MODULE dettonville.git_inventory.update_groups (/Users/ljohnson/tmp/_Y6xp78/ansible_collections/dettonville/git_inventory/plugins/modules/update_groups.py)
...
- create_empty_groupvars_files  Creates empty vars files ('group_vars/' or 'host_vars/') for
...
- inventory_repo_dir  Path to base directory where the inventory git repository will be
                       cloned.
...
- use_vars_files  Use vars files ('group_vars/') for group vars instead of inline
                   group_vars.
        default: true
        type: bool
...
- inventory_repo_dir  The path of the inventory repo directory that was updated

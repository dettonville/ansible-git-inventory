...
def pytest_configure():
    """
    Ensures 'ansible_collections.dettonville.git_inventory' is resolvable
    for bare pytest calls from any location.
    """
    # 1. If already resolvable (e.g., via run-tests.sh), do nothing
    try:
        import ansible_collections.dettonville.git_inventory  # noqa: F401
        return
    except ImportError:
        pass
    ...
    target_dir = tmp_dir / "ansible_collections" / "dettonville" / "git_inventory"

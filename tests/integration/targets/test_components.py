...
COMPONENT_NAMES = ['update_inventory']
...
def get_test_cases() -> list[tuple[str, str]]:
    ...
    for test_component in COMPONENT_NAMES:
        ...
        for filename in test_var_files:
            ...
            # # ref: https://stackoverflow.com/questions/29403784/python-extract-pattern-from-string-using-regex#29403830
            # for testcase in re.findall(r'testdata_(.*?).yml', str(filename)):

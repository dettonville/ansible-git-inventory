...
def run_module():
    ...
    create_empty_hostvars_files = module.params.get("create_empty_hostvars_files")
    ...
    always_add_host_to_root_hosts = module.params.get("always_add_host_to_root_hosts")
    ...
    update_result = inventory_repo.update_inventory(
        group_list=group_list, host_list=host_list, state=state
    )

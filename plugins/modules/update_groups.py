...
short_description: >-
  Add/update group nodes and respective variable settings to a specified
  YAML-file based inventory.
description:
  - Ansible module to add, update, and/or remove group nodes to a specified
    YAML-file based inventory repository.
...
options:
    ...
    use_vars_files:
        description:
            - Use vars files ('group_vars/') for group vars instead of inline
              group_vars.
        type: bool
        default: true
...
module_args = dict(
    ...
    group_list=dict(
        required=True, aliases=["groups"], type="list", elements="dict"
    ),
